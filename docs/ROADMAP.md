...
| Docs — Read the Docs | In progress | **`.readthedocs.yml`** + **PyPI `Documentation`** URL (**RTD `latest`**); manual, guides, and API reference expand over releases ([Documentation platform](#documentation-platform-read-the-docs)). |
